...
- [advanced_weapon_controller.gd](../scripts/genre_shooter_advanced_weapon_controller.gd) - Professional-grade weapon system with deterministic recoil, bloom, and dual hitscan/projectile modes.
