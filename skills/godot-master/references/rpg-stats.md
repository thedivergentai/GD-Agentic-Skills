...
### [status_effect_data.gd](../scripts/genre_moba_status_effect_data.gd)
...
- Related: Matrix-test power curves and modifier stacks with [godot-monte-carlo-balancer](../SKILL.md).
