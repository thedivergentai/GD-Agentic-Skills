...
Scale with [rich_text_image_scaler.gd](../scripts/ui_rich_text_rich_text_image_scaler.gd).

## User chat

**MANDATORY** [rich_text_bbcode_sanitizer.gd](../scripts/ui_rich_text_rich_text_bbcode_sanitizer.gd) before assigning player text.
