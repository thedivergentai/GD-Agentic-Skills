...
Scripts: [collision_bitmask_helper.gd](../scripts/2d_physics_collision_bitmask_helper.gd), [collision_layer_matrix_manager.gd](../scripts/2d_physics_collision_layer_matrix_manager.gd).
