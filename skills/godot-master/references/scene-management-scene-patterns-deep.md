...
Prefer [async_scene_manager.gd](../scripts/scene_management_async_scene_manager.gd) for threaded loads.
...
See [scene_transition_manager.gd](../scripts/scene_management_scene_transition_manager.gd).
...
Full pattern in [async_scene_manager.gd](../scripts/scene_management_async_scene_manager.gd) — always handle `THREAD_LOAD_FAILED`.
...
High-frequency spawns → [scene_pool.gd](../scripts/scene_management_scene_pool.gd).
...
Prefer [persistent_data_preservation.gd](../scripts/scene_management_persistent_data_preservation.gd) + Autoload data for most games.
...
Start `load_threaded_request` during gameplay; swap when `THREAD_LOAD_LOADED` — [background_resource_loader.gd](../scripts/scene_management_background_resource_loader.gd).
