...
> **MANDATORY** for clipboard/share flows, service locator registration, and VLS examples beyond [comp_orchestrator_base.gd](../scripts/composition_apps_comp_orchestrator_base.gd).
...
Component: [clipboard_copier.gd](../scripts/composition_apps_clipboard_copier.gd). Auth flows: [`resources/auth_component.gd`](https://github.com/thedivergentai/gd-agentic-skills/blob/main/skills/godot-composition-apps/resources/auth_component.gd) in this skill package.
...
Production: [comp_logic_visual_syncer.gd](../scripts/composition_apps_comp_logic_visual_syncer.gd).
...
**MANDATORY** [comp_rock_test_boilerplate.gd](../scripts/composition_apps_comp_rock_test_boilerplate.gd) before shipping new app components.
