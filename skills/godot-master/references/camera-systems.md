...
### 3. Trauma audit
Plot trauma decay (debug draw) while tuning [camera_shake_trauma_pro.gd](../scripts/camera_systems_camera_shake_trauma_pro.gd) — never validate feel with raw `randf` offset demos.
