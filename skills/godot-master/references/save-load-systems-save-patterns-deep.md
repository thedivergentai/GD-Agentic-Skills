...
Always include `"version"` and migrate before applying player state — see [save_migration_manager.gd](../scripts/save_load_systems_save_migration_manager.gd).
...
Nodes in group `persist` / `Persist` implement `save()` / `load()`. Manager walks `get_nodes_in_group` — see [save_load_patterns.gd](../scripts/save_load_systems_save_load_patterns.gd).
...
| Version field | Enables [save_migration_manager.gd](../scripts/save_load_systems_save_migration_manager.gd) |
...
Scripts: [save_system_encryption.gd](../scripts/save_load_systems_save_system_encryption.gd), [save_integrity_validator.gd](../scripts/save_load_systems_save_integrity_validator.gd).
