...
| Pattern | Script |
|---------|--------|
| Dynamic move stick (left half) | [dynamic_joystick_spawner.gd](../scripts/dynamic_joystick_spawner.gd) |
| Fixed-base stick | [virtual_joystick.gd](../scripts/virtual_joystick.gd) |
| Swipe / pinch / tap | [gesture_combo_system.gd](../scripts/gesture_combo_system.gd) |
| Camera pan + pinch | [touch_camera_pan_zoom.gd](../scripts/touch_camera_pan_zoom.gd) |
...
[mobile_ui_adapter.gd](../scripts/mobile_ui_adapter.gd) + [ui_safe_area_margins.gd](../scripts/ui_safe_area_margins.gd):
...
[resolution_scaler.gd](../scripts/resolution_scaler.gd) + [mobile_shader_fallback.gd](../scripts/mobile_shader_fallback.gd):
...
[battery_saver_mode.gd](../scripts/battery_saver_mode.gd) on `NOTIFICATION_APPLICATION_PAUSED`:
...
[offline_save_sync.gd](../scripts/offline_save_sync.gd): `NOTIFICATION_WM_CLOSE_REQUEST` is unreliable on mobile kill — persist on pause.
...
| Problem | Mitigation |
|---------|------------|
| OSK covers LineEdit | [on_screen_keyboard_handler.gd](../scripts/on_screen_keyboard_handler.gd) tweens UI up |
