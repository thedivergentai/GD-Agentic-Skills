...
> **MANDATORY** when starting base-building snap or biome/noise work: read [survival-elite-implementations.md](references/survival-elite-implementations.md). **Do NOT Load** for first-pass needs/inventory/crafting — use the script catalog above.
