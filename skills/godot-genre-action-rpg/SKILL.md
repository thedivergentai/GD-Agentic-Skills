...
- [combat_damage_calculator.gd](scripts/combat_damage_calculator.gd) — diminishing-returns damage + crit roll.
- [loot_generator.gd](scripts/loot_generator.gd) — weighted rarity + affix count by tier.
- [enemy_area_scaler.gd](scripts/enemy_area_scaler.gd) — area-level stat/XP multiplier at spawn.
...
> **MANDATORY** for combat/loot/equipment/area-scaling depth beyond decision trees: [arpg-subsystems-deep.md](references/arpg-subsystems-deep.md). **Do NOT Load** for first-pass hitbox + stats wiring — use scripts above.
