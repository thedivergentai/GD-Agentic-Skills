...
> **MANDATORY** for threaded level loads, MainLoop extensions, and archive UI depth beyond [collection_manager.gd](../scripts/collection_manager.gd).
...
See [collection_loop_patterns.gd](../scripts/collection_loop_patterns.gd).
...
[hidden_item_spawner.gd](../scripts/hidden_item_spawner.gd) — Marker3D anchors + chance; fixed hunts skip this script.
