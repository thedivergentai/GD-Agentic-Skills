...
> **MANDATORY** when wiring Input → Movement → Health orchestrators beyond [composition_root_init.gd](../scripts/composition_root_init.gd). Components live in `scripts/` — this file holds pedagogy only.
...
Production movement: [velocity_component.gd](../scripts/velocity_component.gd).

## Health component

[health_component.gd](../scripts/health_component.gd) — context-agnostic HP; orchestrator connects `died` to despawn/VFX.

## State-component FSM

[state_component_vsm.gd](../scripts/state_component_vsm.gd) — child nodes as states. Deeper FSMs: [godot-state-machine-advanced](https://github.com/thedivergentai/gd-agentic-skills/blob/main/skills/godot-state-machine-advanced/SKILL.md).
